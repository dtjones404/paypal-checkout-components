!function(e, a) {
    ...
    function componentTemplate(_ref17) {
        ...
        var buttonNodes = function(_ref4) {
            ...
            return function(_ref11) {
                ...
                if (determineLabel({
                    ...
                    allowedPersonalizationLabels.indexOf(label);
                    contentText = getButtonConfig(label, "label");
                } else contentText = getButtonConfig(label, "logoLabel");
                var dynamicContent = {
                    installmentperiod: installmentperiod,
                    locale: locale
                };
        ...
        return jsxToHTML("div", _extends({}, (_ref18 = {}, _ref18["data-version"] = "4.0.305", 
        _ref18), {
