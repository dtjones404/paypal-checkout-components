!function(e, a) {
    ...
    var BUTTON_CONFIG = ((_BUTTON_CONFIG = {})[DEFAULT] = {
        ...
        logoColors: (_logoColors4 = {}, _logoColors4.silver = "black", _logoColors4.black = "white", 
        _logoColors4.white = "black", _logoColors4),
        ...
        defaultColor: "silver",
        colors: [ "transparent" ],
        logoColors: (_logoColors13 = {}, _logoColors13.transparent = "black", _logoColors13),
    ...
    _FUNDING_TO_DEFAULT_L[FUNDING.VENMO] = "venmo", _FUNDING_TO_DEFAULT_L[FUNDING.CARD] = "card", 
    _FUNDING_TO_DEFAULT_L[FUNDING.CREDIT] = "credit", _FUNDING_TO_DEFAULT_L[FUNDING.IDEAL] = "ideal", 
    _FUNDING_TO_DEFAULT_L[FUNDING.ELV] = "elv", _FUNDING_TO_DEFAULT_L[FUNDING.BANCONTACT] = "bancontact", 
    _FUNDING_TO_DEFAULT_L[FUNDING.GIROPAY] = "giropay", _FUNDING_TO_DEFAULT_L[FUNDING.SOFORT] = "sofort", 
    _FUNDING_TO_DEFAULT_L[FUNDING.EPS] = "eps", _FUNDING_TO_DEFAULT_L[FUNDING.P24] = "p24", 
    _FUNDING_TO_DEFAULT_L[FUNDING.ZIMPLER] = "zimpler", _FUNDING_TO_DEFAULT_L[FUNDING.MYBANK] = "mybank", 
    ...
    _LABEL_TO_FUNDING.ideal = FUNDING.IDEAL, _LABEL_TO_FUNDING.bancontact = FUNDING.BANCONTACT, 
    _LABEL_TO_FUNDING.giropay = FUNDING.GIROPAY, _LABEL_TO_FUNDING.giropay = FUNDING.EPS, 
    _LABEL_TO_FUNDING.sofort = FUNDING.SOFORT, _LABEL_TO_FUNDING.p24 = FUNDING.P24, 
    _LABEL_TO_FUNDING.zimpler = FUNDING.ZIMPLER, _LABEL_TO_FUNDING.mybank = FUNDING.MYBANK, 
    _LABEL_TO_FUNDING);
    ...
    var FUNDING_PRIORITY = [ FUNDING.PAYPAL, FUNDING.VENMO, FUNDING.CREDIT, FUNDING.CARD, FUNDING.IDEAL, FUNDING.ELV, FUNDING.BANCONTACT, FUNDING.GIROPAY, FUNDING.EPS, FUNDING.SOFORT, FUNDING.MYBANK, FUNDING.P24, FUNDING.ZIMPLER ];
    var FUNDING_ORDER = [ FUNDING.PAYPAL, FUNDING.VENMO, FUNDING.CREDIT, FUNDING.IDEAL, FUNDING.ELV, FUNDING.BANCONTACT, FUNDING.GIROPAY, FUNDING.EPS, FUNDING.SOFORT, FUNDING.MYBANK, FUNDING.P24, FUNDING.ZIMPLER, FUNDING.CARD ];
    var FUNDING_CONFIG = ((_FUNDING_CONFIG = {})[DEFAULT] = {
        ...
        defaultVerticalCountries: [ "DE", "AT" ],
        allowHorizontal: !1,
        allowVertical: !0
            ...
            var eligibleFunding = FUNDING_PRIORITY.filter((function(source) {
                var _isFundingEligible = function(source, _ref3) {
                    ...
                    var ineligibleReason = function(source, _ref) {
                        ...
                        return getFundingConfig(source, "vertical" === _ref.layout ? "allowVertical" : "allowHorizontal") ? -1 !== funding.disallowed.indexOf(source) && getFundingConfig(source, "allowOptOut") || -1 !== funding.disallowed.indexOf(source) && source === FUNDING.VENMO ? "The funding source was disallowed in funding.disallowed" : -1 === getFundingConfig(source, "allowedCountries", [ locale.country ]).indexOf(locale.country) ? "The funding source is not enabled for the current locale" : getFundingConfig(source, "requireCommitAsTrue") && !commit ? "The funding source is not enabled when commit is not set as true" : void 0 : "The funding source is disallowed as a secondary button";
                    }(source, {
                        locale: locale,
                        funding: funding,
                        layout: layout,
    ...
    var ZIMPLER_LOGO_COLORS = ((_ZIMPLER_LOGO_COLORS = {}).white = {
        primary: "#ffffff"
    }, _ZIMPLER_LOGO_COLORS.black = {
        primary: "#00A599"
    }, _ZIMPLER_LOGO_COLORS.any = {
        primary: "#00A599"
    ...
    var _BUTTON_LOGO$PP, _BUTTON_LOGO$VENMO, _BUTTON_LOGO$ELV, _fundingLogos;
    ...
    _BUTTON_LOGO$VENMO), _fundingLogos.ideal = function(_ref) {
        var logoColor = _ref.logoColor;
    ...
    }, _fundingLogos.zimpler = function(_ref) {
        var logoColor = _ref.logoColor;
    ...
    function renderCards(_ref5) {
        var button = _ref5.button, layout = _ref5.layout, size = _ref5.size;
        return _ref5.cards.map((function(name) {
            ...
            _ref6), ((_ref7 = {})["data-size"] = size || "", _ref7), ((_ref8 = {})["data-button"] = button || !1, 
            _ref8["data-funding-source"] = "" + FUNDING.CARD, _ref8["data-card"] = "" + name, 
            _ref8), {
    ...
    function renderContent(text, _ref10) {
        var label = _ref10.label, locale = _ref10.locale, color = _ref10.color, branding = _ref10.branding, logoColor = _ref10.logoColor, funding = _ref10.funding, env = _ref10.env, _cards = _ref10.cards, dynamicContent = _ref10.dynamicContent, layout = _ref10.layout, size = _ref10.size;
    ...
    function componentTemplate(_ref17) {
        ...
        var buttonNodes = function(_ref4) {
            ...
            return function(_ref11) {
                ...
                var size = _ref11.size, label = _ref11.label, color = _ref11.color, locale = _ref11.locale, branding = _ref11.branding, multiple = _ref11.multiple, layout = _ref11.layout, shape = _ref11.shape, source = _ref11.source, funding = _ref11.funding, i = _ref11.i, env = _ref11.env, cards = _ref11.cards, installmentperiod = _ref11.installmentperiod;
                var logoColor = getButtonConfig(label, "logoColors")[color];
                var contentText = getButtonConfig(label, determineLabel({
                    label: label,
                    source: source,
                    multiple: multiple,
                    layout: layout
                }) === label ? "label" : "logoLabel");
                var dynamicContent = {
                    installmentperiod: installmentperiod,
                    locale: locale
                };
                ...
                return jsxToHTML("div", _extends({}, ((_ref12 = {})["data-layout"] = layout || "", 
                _ref12), ((_ref13 = {})["data-size"] = size || "", _ref13), ((_ref14 = {})["data-funding-source"] = source, 
                _ref14["data-button"] = !0, _ref14), {
        ...
        var taglineNode = function(_ref15) {
        ...
        var scriptNode = jsxToHTML("script", {
            innerHTML: "(" + function() {
                ...
                function showElement(el, displayType) {
                    void 0 === displayType && (displayType = "inline-block");
        ...
        return jsxToHTML("div", _extends({}, (_ref18 = {}, _ref18["data-version"] = "4.0.271", 
        _ref18), {
