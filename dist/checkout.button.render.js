!function(e, a) {
    ...
    var BUTTON_CONFIG = ((_BUTTON_CONFIG = {})[DEFAULT] = {
        ...
        defaultColor: "silver",
        colors: [ "transparent" ],
        logoColors: (_logoColors19 = {}, _logoColors19.transparent = BUTTON_LOGO_COLOR.BLACK, 
        _logoColors19),
        secondaryColors: (_secondaryColors19 = {}, _secondaryColors19.gold = "transparent", 
        _secondaryColors19.blue = "transparent", _secondaryColors19.silver = "transparent", 
        _secondaryColors19.black = "transparent", _secondaryColors19.darkblue = "transparent", 
        _secondaryColors19.white = "transparent", _secondaryColors19),
        allowPrimary: !1,
        allowPrimaryVertical: !1,
        allowPrimaryHorizontal: !1
    }, _BUTTON_CONFIG);
    ...
    var FUNDING_PRIORITY = [ FUNDING.PAYPAL, FUNDING.VENMO, FUNDING.ITAU, FUNDING.CREDIT, FUNDING.CARD, FUNDING.IDEAL, FUNDING.ELV, FUNDING.BANCONTACT, FUNDING.GIROPAY, FUNDING.EPS, FUNDING.SOFORT, FUNDING.MYBANK, FUNDING.P24, FUNDING.PAYU, FUNDING.VERKKOPANKKI, FUNDING.BLIK, FUNDING.TRUSTLY, FUNDING.MAXIMA, FUNDING.BOLETO ];
    var FUNDING_ORDER = [ FUNDING.PAYPAL, FUNDING.VENMO, FUNDING.ITAU, FUNDING.CREDIT, FUNDING.IDEAL, FUNDING.ELV, FUNDING.BANCONTACT, FUNDING.GIROPAY, FUNDING.EPS, FUNDING.SOFORT, FUNDING.MYBANK, FUNDING.P24, FUNDING.PAYU, FUNDING.VERKKOPANKKI, FUNDING.BLIK, FUNDING.TRUSTLY, FUNDING.MAXIMA, FUNDING.BOLETO, FUNDING.CARD ];
    var FUNDING_CONFIG = ((_FUNDING_CONFIG = {})[DEFAULT] = {
        ...
        allowedCountries: [ "DE", "DK", "EE", "ES", "FI", "GB", "IT", "MT", "NL", "NO", "PL", "SE" ],
        allowHorizontal: !1,
        allowVertical: !0,
        requireCommitAsTrue: !0
            ...
            var eligibleFunding = FUNDING_PRIORITY.filter((function(source) {
                var _isFundingEligible = function(source, _ref3) {
                    ...
                    var ineligibleReason = function(source, _ref) {
                        ...
                        return getFundingConfig(source, "vertical" === _ref.layout ? "allowVertical" : "allowHorizontal") ? -1 !== funding.disallowed.indexOf(source) && getFundingConfig(source, "allowOptOut") || -1 !== funding.disallowed.indexOf(source) && source === FUNDING.VENMO || -1 !== funding.disallowed.indexOf(source) && source === FUNDING.ITAU ? "The funding source was disallowed in funding.disallowed" : -1 === getFundingConfig(source, "allowedCountries", [ locale.country ]).indexOf(locale.country) ? "The funding source is not enabled for the current locale" : getFundingConfig(source, "requireCommitAsTrue") && !commit ? "The funding source is not enabled when commit is not set as true" : void 0 : "The funding source is disallowed as a secondary button";
                    }(source, {
                        locale: locale,
                        funding: funding,
                        layout: layout,
    ...
    var allowedPersonalizationLabels = [ "paypal", "checkout", "buynow", "pay", "installment" ];
    ...
    function componentTemplate(_ref17) {
        ...
        var buttonNodes = function(_ref4) {
            ...
            return function(_ref11) {
                ...
                var size = _ref11.size, label = _ref11.label, color = _ref11.color, locale = _ref11.locale, branding = _ref11.branding, multiple = _ref11.multiple, layout = _ref11.layout, shape = _ref11.shape, source = _ref11.source, funding = _ref11.funding, i = _ref11.i, env = _ref11.env, cards = _ref11.cards, installmentperiod = _ref11.installmentperiod, checkoutCustomization = _ref11.checkoutCustomization;
                ...
                if (buttonLabel === label) if (-1 !== allowedPersonalizationLabels.indexOf(label) && morsText) {
                ...
                } else contentText = getButtonConfig(label, "label"); else contentText = getButtonConfig(label, "logoLabel");
                var dynamicContent = {
                    installmentperiod: installmentperiod,
                    locale: locale
                };
                contentText = renderContent(contentText = "function" != typeof contentText || morsText && "installment" === label ? contentText : contentText(dynamicContent), {
                    label: label,
                    locale: locale,
                    color: color,
                    branding: branding,
                ...
                }), contentText, impression && function(impression) {
        ...
        var taglineNode = function(_ref15) {
            var label = _ref15.label, color = _ref15.color, locale = _ref15.locale, env = _ref15.env, cards = _ref15.cards, checkoutCustomization = _ref15.checkoutCustomization;
            if (_ref15.tagline) {
                var tag = _ref15.multiple && getButtonConfig(label, "dualTag") || getButtonConfig(label, "tag");
        ...
        return jsxToHTML("div", _extends({}, (_ref18 = {}, _ref18["data-version"] = "4.0.287", 
        _ref18), {
