!function(e, a) {
    ...
    "./src/button/template/componentTemplate.jsx": function(module, __webpack_exports__, __webpack_require__) {
        ...
        _LABEL_TO_FUNDING[constants.f.GIROPAY] = constants.t.EPS, _LABEL_TO_FUNDING[constants.f.MYBANK] = constants.t.MYBANK, 
        ...
        var FUNDING_PRIORITY = [ constants.t.PAYPAL, constants.t.VENMO, constants.t.CREDIT, constants.t.IDEAL, constants.t.ELV, constants.t.BANCONTACT, constants.t.GIROPAY, constants.t.EPS, constants.t.MYBANK, constants.t.CARD ], FUNDING_CONFIG = ((_FUNDING_CONFIG = {})[constants.r] = {
            enabled: !0,
            allowOptIn: !0,
            allowOptOut: !0,
            allowRemember: !0,
        ...
        __webpack_exports__.componentTemplate = function(_ref12) {
            ...
            var script;
            return jsxToHTML("div", _extends({}, (_ref13 = {}, _ref13[constants.c.VERSION] = "4.0.201", 
            _ref13), {
    ...
    "./src/config/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        var _checkoutUris, _altpayUris, _guestUris, _billingUris, _buttonUris, _postBridgeUris, _legacyCheckoutUris, _buttonJSUrls, _locales, constants = __webpack_require__("./src/constants/index.js"), config = {
            ...
            get wwwApiUrls() {
                var _ref3;
                return (_ref3 = {})[constants.s.LOCAL] = "https://www." + config.stage + ".qa.paypal.com", 
            ...
            get corsApiUrls() {
                var _ref4;
                return (_ref4 = {})[constants.s.LOCAL] = "https://" + config.apiStage + ".qa.paypal.com:12326", 
            ...
            get loginUrls() {
                ...
                return (_ref11 = {})[constants.s.LOCAL] = "" + paypalUrls.stage + config.loginUri, 
            ...
            get paymentsStandardUrls() {
                ...
                return (_ref12 = {})[constants.s.LOCAL] = "" + paypalUrls.local + config.paymentStandardUri, 
            ...
            get metaFrameUrls() {
                ...
                return (_ref13 = {})[constants.s.LOCAL] = "" + paypalUrls.local + config.postBridgeUri + "&env=local", 
            ...
            get legacyCheckoutUrls() {
                ...
                return (_ref14 = {})[constants.s.LOCAL] = "" + paypalUrls.stage + config.legacyCheckoutUris.local, 
            ...
            get authApiUrls() {
                ...
                return (_ref15 = {})[constants.s.LOCAL] = "" + apiUrls.local + authApiUri, _ref15[constants.s.STAGE] = "" + apiUrls.stage + authApiUri, 
                _ref15[constants.s.SANDBOX] = "" + apiUrls.sandbox + authApiUri, _ref15[constants.s.PRODUCTION] = "" + apiUrls.production + authApiUri, 
                _ref15[constants.s.TEST] = "" + apiUrls.test + authApiUri, _ref15;
            },
            get paymentApiUrls() {
                var _ref16, apiUrls = config.apiUrls, paymentApiUri = config.paymentApiUri;
                return (_ref16 = {})[constants.s.LOCAL] = "" + apiUrls.local + paymentApiUri, _ref16[constants.s.STAGE] = "" + apiUrls.stage + paymentApiUri, 
                _ref16[constants.s.SANDBOX] = "" + apiUrls.sandbox + paymentApiUri, _ref16[constants.s.PRODUCTION] = "" + apiUrls.production + paymentApiUri, 
                _ref16[constants.s.TEST] = "" + apiUrls.test + paymentApiUri, _ref16;
            },
            get orderApiUrls() {
                var _ref17, apiUrls = config.apiUrls, orderApiUri = config.orderApiUri;
                return (_ref17 = {})[constants.s.LOCAL] = "" + apiUrls.local + orderApiUri, _ref17[constants.s.STAGE] = "" + apiUrls.stage + orderApiUri, 
                _ref17[constants.s.SANDBOX] = "" + apiUrls.sandbox + orderApiUri, _ref17[constants.s.PRODUCTION] = "" + apiUrls.production + orderApiUri, 
                _ref17[constants.s.TEST] = "" + apiUrls.test + orderApiUri, _ref17;
            },
            get billingApiUrls() {
                var _ref18, apiUrls = config.apiUrls, billingApiUri = config.billingApiUri;
                return (_ref18 = {})[constants.s.LOCAL] = "" + apiUrls.local + billingApiUri, _ref18[constants.s.STAGE] = "" + apiUrls.stage + billingApiUri, 
                _ref18[constants.s.SANDBOX] = "" + apiUrls.sandbox + billingApiUri, _ref18[constants.s.PRODUCTION] = "" + apiUrls.production + billingApiUri, 
                _ref18[constants.s.TEST] = "" + apiUrls.test + billingApiUri, _ref18;
            },
            get experienceApiUrls() {
                var _ref19, apiUrls = config.apiUrls, experienceApiUri = config.experienceApiUri;
                return (_ref19 = {})[constants.s.LOCAL] = "" + apiUrls.local + experienceApiUri, 
            ...
            get trackingApiUrls() {
                ...
                return (_ref20 = {})[constants.s.LOCAL] = "" + apiUrls.local + trackingApiUri, _ref20[constants.s.STAGE] = "" + apiUrls.stage + trackingApiUri, 
                _ref20[constants.s.SANDBOX] = "" + apiUrls.sandbox + trackingApiUri, _ref20[constants.s.PRODUCTION] = "" + apiUrls.production + trackingApiUri, 
                _ref20[constants.s.TEST] = "" + apiUrls.test + trackingApiUri, _ref20;
            },
            _paypalUrl: "",
            get paypalUrl() {
